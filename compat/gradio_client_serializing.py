"""Backport of gradio_client.serializing from gradio-client 0.2.x for compatibility."""
...
try:
    # gradio_client<2.0 exposed media_data at package root; newer versions removed it.
    from gradio_client import media_data, utils
except ImportError:  # pragma: no cover - fallback for gradio_client>=2.0
    from gradio_client import utils
    import base64

    _placeholder = base64.b64encode(b"placeholder").decode()

    class _MediaData:
        BASE64_IMAGE = _placeholder
        BASE64_FILE = _placeholder
        BASE64_VIDEO = _placeholder

    media_data = _MediaData()  # type: ignore
